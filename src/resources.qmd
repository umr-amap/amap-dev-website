...
The Julia section is not perfectly curated ; not all links listed here are duplicated with their related sections on this website (eg the [Documentation](documentation.qmd#julia-users) section has different compared to the small subsection [below](resources.qmd#documentation)). Some links also cover multiple topics.
...
An overview of options for code quality, testing, ... :
https://scientificcoder.com/automate-your-code-quality-in-julia
...
Another couple of courses, "Julia for Machine Learning" and "Introduction to Scientific Programming and Machine Learning with Julia". The first contains some sections on the basics of the language, and some extensive workflow tutorials, including setting up a package, testing and documenting it, common mistakes. The second has a section on the basics, with quizes, sections related to scientific computing and machine learning, and a 'Further topics sections', which also contains examples of [how to interface Julia with other languages](https://sylvaticus.github.io/SPMLJ/stable/01_-_JULIA1_-_Basic_Julia_programming/0106_-_Further_topics.html#Interfacing-with-other-languages). That course evolved from another course more focused on the basics, which you can find [here](https://syl1.gitbook.io/julia-language-a-concise-tutorial)

https://adrianhill.de/julia-ml-course/
https://sylvaticus.github.io/SPMLJ/stable/

Rémi Vézy, a researcher at AMAP, also started a [video series](https://www.youtube.com/watch?v=ZZJJgQ2IzQQ&list=PLLiJ249IkzRFxZGALbKy75_ZyHxYCUmuk) (incomplete) presenting the basics of the Julia language.

### Exercises

Online exercises, with other users' solutions made available after an exercise is completed. Julia has a rich syntax with many operators and plenty of different ways of accomplishing the same task (some more verbose, less flexible, more obscure, ...), which can make learning the language's extensive features quite slow at first. Being able to compare your code with alternative solutions can help learn new keywords.
https://exercism.org/tracks/julia

There are other websites providing exercises to learn Julia, but exercism is one that has been used by learners at AMAP.
...
Note : Most of the resources posted in the [overview and tutorials](resources.qmd#overviews-and-tutorial-series) section will also cover some of the following topics, so make sure to check them out as well.
...
See the related [CI/CD](ci_cd.qmd#examples-for-a-julia-package) section
...
https://github.com/JuliaTesting/Aqua.jl?tab=readme-ov-file Aqua.jl
...
Metaprogramming is a large topic in Julia. `eval()` has subtleties and pitfalls. No related links listed here yet.
