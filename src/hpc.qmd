...
...
cutesv/2.0.3                       HTStream/1.3.0                     orthofinder/2.5.4-bin              silix/1.3.0                        wrath/20240603
cutesv/2.0.3-conda                 iced/0.5.10                        pal2nal/v14                        simka/1.5.3-singularity            wtdbg/2.3
CViT/1.2.1-bin                     IFB/ifb.modules                    paleomix/1.3.2                     simplesynteny/1.3.2-bin            wu-blast/2.26
dagchainer/02.06.2008              ImageMagick/6.9.12-14              paml/4.9.0                         sine_scan/1.1.1                    xclip/0.12
...
```
- `module load my_module` : load a module, e.g. `module load R/packages/4.1.0`
- `module unload my_module` : unload a module
- `module list` : list all the loaded modules
