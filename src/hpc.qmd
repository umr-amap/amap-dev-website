...
Main specifications of `IO - ISDM-Meso` are descrbed at the [dedicated section of the documentation website](https://docs.meso.umontpellier.fr/fr/HPC/CLUSTER/cluster-io-specifications). Some additional specific to usage at CIRAD can be found in the [dedicated documentation](https://agap.gitlab.cirad.fr/cluster/documentation/).
...
- __CPU__ node. Partition name : `dedicated-cpu@cirad`, `dedicated-cpu@cirad-normal`, `dedicated-cpu@cirad-long`

- __GPU__ node. Partition name : `dedicated-cpu@cirad-gpu`

You can find the list of partitions available on the cluster with the command `sacctmgr show assoc user=$(whoami) format=User,Account%30,DefaultQOS%30,QOS%75`.
